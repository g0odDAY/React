...
const Equipment = ({equipment})=>{
    console.log(JSON.parse(equipment.Tooltip).Element_000.value)
    const component = Object.entries(JSON.parse(equipment.Tooltip)).map(([key,value],idx)=>{
        if (value.type === 'NameTagBox') {
            ...
            console.log(value.value.Element_000.includes('세트 효과'));
            ...
            <div>
                <div className={classes.equipment}>
                    ...
                    <div>
                        ...
                        {<ItemPartBox value={JSON.parse(equipment.Tooltip).Element_008} />}
